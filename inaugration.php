            ...
            <div class="row">
                <div class="">
                   <div class="row-gallery">
							...
							?>
								<div class="column">
								<img src="<?php echo "images/gallery/inaugration/". $file ?>" onclick="openModal();currentSlide(<?php echo $t; ?>)" class="hover-shadow">
								<?php  $t=$t+1; ?>
								</div>
							...
							<div id="myModal" class="modal">
							  ...
							  <div class="model-content">
								...
								<div class="mySlides">
								  ...
								  <img src="<?php echo "images/gallery/inaugration/". $file ?>" style="width:80%">
								 <?php   $j=$j+1; ?>
								</div>
								<?php
								}
    ...
    <!-- Thumbnail image controls -->
						<?php
							...
							?>	
								...
								<div class="column">
								<img src="<?php echo "images/gallery/inaugration/". $file ?>" onclick="openModal();currentSlide(<?php echo $k; ?>)" class="hover-shadow">
								<?php  $k=$k+1; ?>
								</div>
